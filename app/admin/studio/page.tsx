              ...
              return (
                ...
                >
                  ...
                  {clientProjects.length > 0
                    ...
                    : <div style={{ fontFamily: "var(--font-mono)", fontSize: "var(--text-eyebrow)", opacity: 0.3, letterSpacing: "0.08em", textTransform: "uppercase" }}>No projects</div>
                  }
  ...
  return (
    <Link href={href} style={{ display: "block", padding: "13px 0", borderBottom: "0.5px solid rgba(15,15,14,0.1)", textDecoration: "none" }}>
      <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 4 }}>
        ...
        <span style={{ fontFamily: "var(--font-mono)", fontSize: 7, letterSpacing: "0.1em", textTransform: "uppercase", padding: "3px 7px", border: `0.5px solid ${tagColor}60`, color: tagColor }}>{tag}</span>
      </div>
