          ...
          <div style={{ display: "flex", alignItems: "flex-start", gap: 14, flex: 1 }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ display: "flex", alignItems: "baseline", gap: 10, flexWrap: "wrap", marginBottom: 6 }}>
                ...
                {item.is_recommended && (
                  <span style={{ ...mono, fontSize: 9, letterSpacing: "0.1em", textTransform: "uppercase", padding: "3px 8px", border: "0.5px solid rgba(232,200,91,0.45)", color: "#b5a042" }}>
                    Recommended
                  </span>
                )}
              </div>
      ...
      if (label && label !== lastPhaseLabel) {
        result.push(
          <div key={`phase-${label}`} style={{
            ...serif, fontSize: isMobile ? 17 : 19, fontWeight: 600,
