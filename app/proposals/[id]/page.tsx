...
export default function ProposalPage({ params }: { params: { id: string } }) {
      ...
      {canInteract && (
        <>
          ...
          <button
            ...
            style={{
              width: "100%", boxSizing: "border-box",
              background: "#0F0F0E", border: "none", padding: "16px",
  ...
  return (
    <div style={{ background: "linear-gradient(160deg, #F4F1EC 0%, #E8E0D4 100%)", minHeight: "100vh", ...serif }}>
      ...
      <nav style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: isMobile ? 10 : 20 }}>
          {proposal.expires_at && !isExpired && (
            <span style={{ ...mono, fontSize: 8, letterSpacing: "0.1em", textTransform: "uppercase", color: "#B07D3A", opacity: 0.85 }}>
              Exp. {new Date(proposal.expires_at).toLocaleDateString("en-US", { month: "short", day: "numeric" })}
            </span>
          )}
          {isExpired && <span style={{ ...mono, fontSize: 8, letterSpacing: "0.1em", textTransform: "uppercase", color: "#c0392b", opacity: 0.7 }}>Expired</span>}
          {isAccepted && <span style={{ ...mono, fontSize: 8, letterSpacing: "0.1em", textTransform: "uppercase", color: "#6B8F71", opacity: 0.8 }}>Accepted</span>}
          {!isMobile && (
      ...
      {/* Layout */}
      {isMobile ? (
        // Mobile: single column, pricing panel at bottom
        <div>
          <div style={{ padding: "40px 24px 48px" }}>
            {/* Header */}
            <div style={{ marginBottom: 40 }}>
              <div style={{ ...mono, fontSize: 8, letterSpacing: "0.18em", textTransform: "uppercase", opacity: 0.38, marginBottom: 12 }}>
              ...
              {proposal.subtitle && (
                <p style={{ ...serif, fontSize: 14, opacity: 0.55, lineHeight: 1.65 }}>
                  {proposal.subtitle}
                </p>
              )}
            </div>
            ...
            {proposal.overview && (
              <div style={{ marginBottom: 44 }}>
                <div style={{ ...mono, fontSize: 8, letterSpacing: "0.16em", textTransform: "uppercase", opacity: 0.38, marginBottom: 14 }}>Overview</div>
            ...
            <div style={{ marginBottom: 36 }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 4 }}>
                ...
                <div style={{ ...mono, fontSize: 8, opacity: 0.38 }}>Est. ${(baseTotal / 100).toLocaleString()}</div>
              </div>
            ...
            {optionalItems.length > 0 && (
              <div style={{ marginBottom: 44 }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 4 }}>
                  ...
                  <div style={{ ...mono, fontSize: 8, opacity: 0.38 }}>+${(optionalTotal / 100).toLocaleString()}</div>
                </div>
            ...
            {proposal.closing && (
              <div style={{ borderTop: "0.5px solid rgba(15,15,14,0.08)", paddingTop: 36 }}>
                <div style={{ ...serif, fontSize: 14, lineHeight: 1.85, opacity: 0.65, whiteSpace: "pre-wrap", marginBottom: 16 }}>
                  {proposal.closing}
                </div>
          ...
          {/* Pricing panel below content on mobile */}
          {pricingPanel}
        </div>
      ) : (
          ...
          <div style={{ padding: "56px 48px 80px 56px", borderRight: "0.5px solid rgba(15,15,14,0.08)" }}>
            ...
            {proposal.overview && (
              <div style={{ marginBottom: 52 }}>
                <div style={{ ...mono, fontSize: 8, letterSpacing: "0.16em", textTransform: "uppercase", opacity: 0.38, marginBottom: 18 }}>Overview</div>
                <div style={{ ...serif, fontSize: 14, lineHeight: 1.85, opacity: 0.72, whiteSpace: "pre-wrap" }}>
                  {proposal.overview}
                </div>
              </div>
