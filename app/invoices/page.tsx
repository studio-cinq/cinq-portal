  ...
  return (
    <div className="portal-card-hover" style={{
      ...
      {variant === "due" && (() => {
        ...
        const showCheck = methods.includes("check") && Boolean(process.env.NEXT_PUBLIC_CHECK_MAILING_ADDRESS)
        return (
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginTop: 12, paddingTop: 14, borderTop: "0.5px solid rgba(15,15,14,0.07)" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              ...
              {showStripe && (
                <PayInvoiceButton invoiceId={inv.id} amount={inv.amount} label={showACH || showVenmo || showCheck ? "Pay with card" : undefined} />
              )}
            </div>
          </div>
        )
